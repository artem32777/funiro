(() => {
    ...
    function initSliders() {
        if (document.querySelector(".firstblock-slider")) new core(".firstblock-slider", {
            ...
            grabCursor: true,
            pagination: {
                el: ".firstblock-slider .firstblock-slider-controller__buttons",
                clickable: true
            },
            navigation: {
                prevEl: ".firstblock-slider .firstblock-slider-controller-arrows_prev",
                nextEl: ".firstblock-slider .firstblock-slider-controller-arrows_next"
            },
            keyboard: {
                enabled: true,
                onlyInViewport: true,
        ...
        if (document.querySelector(".fourthblock-slider")) new core(".fourthblock-slider", {
            modules: [ Navigation, Pagination, Parallax, Keyboard ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            grabCursor: true,
            pagination: {
                el: ".fourthblock-slider .fourthblock-slider__pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".fourthblock-slider .fourthblock-slider__arrows_prev",
                nextEl: ".fourthblock-slider .fourthblock-slider__arrows_next"
            },
            keyboard: {
                enabled: true,
                onlyInViewport: true,
        ...
        if (document.querySelector(".fifthblock-slider")) new core(".fifthblock-slider", {
            ...
            grabCursor: true,
            pagination: {
                el: ".fifthblock-slider .fifthblock-slider__pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".fifthblock-slider .fifthblock-slider__arrows_prev",
                nextEl: ".fifthblock-slider .fifthblock-slider__arrows_next"
            },
            keyboard: {
                enabled: true,
                onlyInViewport: true,
...
***************************************************************************** */
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.classList.contains("actions__search")) document.querySelector(".search").classList.toggle("_active"); else if (!targetElement.closest(".search") && document.querySelector(".search._active")) document.querySelector(".search").classList.remove("_active");
        }
        const headerElement = document.querySelector(".header");
        const callback = function(entrise, observer) {
            if (entrise[0].isIntersecting) headerElement.classList.remove("_scroll"); else headerElement.classList.add("_scroll");
        };
        ...
        function ShowMore(e) {
            const targetElement = e.target;
            if (targetElement.classList.contains("thirdblock__button")) document.querySelector(".thirdblock__hidden-body").classList.toggle("thirdblock__hidden-body_actived");
        }
    };
    window["FLS"] = true;
    isWebp();
